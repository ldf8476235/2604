...
export type AdminImRealtimeState = "connecting" | "connected" | "reconnecting" | "error" | "closed";
...
type RealtimeOptions = {
  ...
  onStateChange?: (state: AdminImRealtimeState) => void;
};

export function createAdminImRealtimeSession(options: RealtimeOptions) {
